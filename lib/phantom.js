...
function wrapFileInBrowserifyTemplate (filePath) {
    ...
    var template = "x = require('mocha/mocha.js'); var webconsole=require('"+__dirname+"/WebConsole.js').WebConsole; mocha.setup({reporter:webconsole}); mocha.ui('bdd'); require('"+templateRelativePath+"'); mocha.run(function() { phantom.exit() });"
